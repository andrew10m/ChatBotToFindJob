...
(
    ...
    VIEW_VACANCIES_LIST # Added VIEW_VACANCIES_LIST here as it's used as a state for apply_vacancy_conv
) = (
    ...
    config.VIEW_VACANCIES_LIST # Make sure VIEW_VACANCIES_LIST is defined in config.py states
)
